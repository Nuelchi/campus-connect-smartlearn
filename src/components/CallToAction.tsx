...
const CallToAction = () => <section className="py-16 bg-gradient-to-r from-emerald-50 to-blue-100" id="contact">
    <div className="max-w-3xl mx-auto text-center">
      ...
      <Link to="/register" className="bg-emerald-600 text-white px-10 py-4 rounded-xl text-xl font-semibold shadow hover:bg-emerald-700 hover:scale-105 transition-all mx-0 my-[20px]">
        Start Free Now
      </Link>
