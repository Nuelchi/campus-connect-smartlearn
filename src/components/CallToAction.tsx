...
const CallToAction = () => (
  <section className="py-12 sm:py-16 bg-gradient-to-r from-emerald-50 to-blue-100 px-4" id="contact">
    <div className="max-w-3xl mx-auto text-center">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-5 text-primary">
        Join SmartLearn today!
      </h2>
      ...
      <Link 
        to="/register" 
        className="inline-block bg-emerald-600 text-white px-8 sm:px-10 py-3 sm:py-4 rounded-xl text-lg sm:text-xl font-semibold shadow hover:bg-emerald-700 hover:scale-105 transition-all"
      >
        Start Free Now
      </Link>
      <div className="mt-8 sm:mt-10 space-y-2 text-gray-700 text-sm sm:text-base">
        <div className="px-4">
